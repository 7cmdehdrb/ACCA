...
class control():
    ...
    def vel_pid(self):
        ...
        self.command_msg.KPH = (self.cmd_vel_msg.linear.x + kp*error + ki*self.cumError) * 3600/1000
    ...
    def cmd_vel_to_command(self):
        ...
        if self.cmd_vel_msg.linear.x != 0 and self.linear_vel != 0:
            self.command_msg.Deg = (-degrees(atan(wheelbase / self.linear_vel * self.cmd_vel_msg.angular.z)))
