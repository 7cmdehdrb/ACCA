...
class control():
    ...
    def handle_data(self, line):
        ...
        self.feedback.KPH = (
            ord(line[6]) + ord(line[7]) * 256)/10  # nominal speed
        ...
        self.feedback.Encoder = (ord(line[11]) + ord(line[12]) * 256 + ord(
    ...
    def callback_cmd(self, msg):
        ...
        self.send_data(int(self.stanley_msg.speed + 1),
                       int(math.degrees(self.stanley_msg.steer)), 1, 2)
...
if __name__ == "__main__":
    ...
    rospy.Subscriber('/cone_stanley_cmd', stanleyMsg, mycar.callback_cmd)

    rospy.Subscriber("/cone_stanley_cmd", stanleyMsg, mycar.stanleyCallback)
    rate = rospy.Rate(50)
