...
class MaRRTPathPlanNode:
    ...
    def __init__(self):
        ...
        self.isLoopClosePub = rospy.Publisher("/is_loop_close", UInt8, queue_size=1)
    ...
    def sampleTree(self):
        ...
        msg.data = 1 if self.loopClosure is True else 0

        self.isLoopClosePub.publish(msg)
        ...
        frontConesDist = 10.0  #
        # print("map {0}".format(len(self.map)))
        ...
        if bestBranch:
            ...
            if filteredBestBranch:
                ...
                # print("EDGE ON" if delaunayEdges else "NO EDGE")
                ...
                # print("WAY ON" if newWaypoints else "NO WAY")
            ...
            if i >= maxWaypointAmountToSave or carWaypointDist > maxDistToSaveWaypoints:
                ...
                for savedWaypoint in reversed(self.savedWaypoints):
                    ...
                    if waypointsDistDiff < waypointsDistTollerance:
                        ...
                        break
                print(self.preliminaryLoopClosure)
                if (self.preliminaryLoopClosure):
                    ...
                    # print(distDiff,waypointsDistTollerance)
                    if distDiff < waypointsDistTollerance:
                        self.loopClosure = True
    ...
    def findBestBranch(self, leafNodes, nodeList, largerGroupFrontCones, coneObstacleSize, expandDistance, planDistance):
        ...
        minAcceptableBranchRating = 50 # fits good fsg18 20
